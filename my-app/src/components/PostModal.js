...
import {postArticleAPI} from './index';
...
const PostModal = (props) =>{
    ...
    return(
       ...
       <Container>
        ...
        <Header>
        <h2>Create a Post </h2>
        <button onClick={(event)=> reset(event)}><i class="fa-regular fa-circle-xmark"></i></button>
       </Header>
       <SharedContent>
        <UserInfo>
       ...
       <Editor><textarea value={editorText} onChange={(e)=> setEditorText(e.target.value)}
       ...
       <SharedComment>
       <AssetButtons> 
       <i className="fa-regular fa-comment-dots"></i>AnyOne
       </AssetButtons>
       </SharedComment>
